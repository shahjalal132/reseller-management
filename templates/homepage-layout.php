    ...
    <div class="rmhp-container rmhp-header-inner">
        ...
        <nav class="rmhp-nav" id="rmhp-nav" aria-label="<?php esc_attr_e( 'Primary Navigation', 'reseller-management' ); ?>">
            <ul class="rmhp-nav-list">
                <li><a href="#rmhp-home"       class="rmhp-nav-link rmhp-scroll-link"><?php esc_html_e( 'Home', 'reseller-management' ); ?></a></li>
                <li><a href="#rmhp-about"      class="rmhp-nav-link rmhp-scroll-link"><?php esc_html_e( 'About Us', 'reseller-management' ); ?></a></li>
                <li><a href="#rmhp-advantages" class="rmhp-nav-link rmhp-scroll-link"><?php esc_html_e( 'Advantages', 'reseller-management' ); ?></a></li>
                <li><a href="#rmhp-categories" class="rmhp-nav-link rmhp-scroll-link"><?php esc_html_e( 'Categories', 'reseller-management' ); ?></a></li>
                <li><a href="#rmhp-company"    class="rmhp-nav-link rmhp-scroll-link"><?php esc_html_e( 'Company', 'reseller-management' ); ?></a></li>
                <li><a href="#rmhp-services"   class="rmhp-nav-link rmhp-scroll-link"><?php esc_html_e( 'Services', 'reseller-management' ); ?></a></li>
                <li><a href="#rmhp-faq"        class="rmhp-nav-link rmhp-scroll-link"><?php esc_html_e( 'FAQ', 'reseller-management' ); ?></a></li>
            </ul>
        </nav>
        ...
        <div class="rmhp-footer-grid">
            ...
            <div class="rmhp-footer-col">
                ...
                <ul class="rmhp-footer-links">
                    <li><a href="#rmhp-home"       class="rmhp-scroll-link"><?php esc_html_e( 'Home', 'reseller-management' ); ?></a></li>
                    <li><a href="#rmhp-about"      class="rmhp-scroll-link"><?php esc_html_e( 'About Us', 'reseller-management' ); ?></a></li>
                    <li><a href="#rmhp-advantages" class="rmhp-scroll-link"><?php esc_html_e( 'Advantages', 'reseller-management' ); ?></a></li>
                    <li><a href="#rmhp-services"   class="rmhp-scroll-link"><?php esc_html_e( 'Services', 'reseller-management' ); ?></a></li>
                    <li><a href="#rmhp-faq"        class="rmhp-scroll-link"><?php esc_html_e( 'FAQ', 'reseller-management' ); ?></a></li>
                </ul>
            </div>
