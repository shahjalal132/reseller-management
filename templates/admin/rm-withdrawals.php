...
jQuery(document).ready(function ($) {
    ...
    function renderTable() {
        ...
        pageRows.forEach( function ( row ) {
            ...
            html +=   '<a href="' + row.view_url + '" class="rm-wd-btn rm-wd-btn-view">View</a>';
            html +=   '<a href="' + row.edit_url + '" class="rm-wd-btn rm-wd-btn-edit is-edit">Edit</a>';
            html +=   '<a href="' + row.delete_url + '" class="rm-wd-btn rm-wd-btn-del" onclick="return confirm(\'Delete this withdrawal?\');">Del</a>';
            html += '</div></td>';
            html += '</tr>';
        } );
