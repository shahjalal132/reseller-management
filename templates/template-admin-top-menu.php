...
<div class="rm-hub-wrap">
    ...
    <div class="rm-hub-content">
        ...
        <?php if ( ! empty( $rm_notice_map[ $rm_notice_key ] ) ) : ?>
            <div class="rm-notice <?php echo esc_attr( $rm_notice_map[ $rm_notice_key ]['type'] ); ?>">
